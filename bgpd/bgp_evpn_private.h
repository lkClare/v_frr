...
{
	assert(local_pi->extra->pevpn);
	return &local_pi->extra->pevpn->vni_info.mac;
}
...
{
	assert(local_pi->extra->pevpn);
	return &local_pi->extra->pevpn->vni_info.ip;
}
...
{
	assert(local_pi->extra->pevpn);
	local_pi->extra->pevpn->vni_info.mac = mac;
}
...
{
	assert(local_pi->extra->pevpn);
	local_pi->extra->pevpn->vni_info.ip = ip;
}
